...
public class MapEditor extends GraphicObject implements ActionListener, MouseListener, MouseMotionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		case 2:
			...
			case "add":
				if (newChild != null && !mapField1.getText().isEmpty() && !mapField1.getText().equals("kid name") && !mapField2.getText().isEmpty() && !mapField2.getText().equals("kid instructions") && instOK(mapField2.getText())) {
			...
			break;
		case 3:
			if (!mapField1.getText().isEmpty() && !mapField1.getText().equals("map name") && !mapField2.getText().isEmpty() && !mapField2.getText().equals("kid name")) {
